...
struct ContentView: View {
    ...
    @State private var draft: CardItem = .blank()
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                TextField("SetName", text: $draft.setName)
                    .accessibilityIdentifier("field_setName")
                TextField("Condition", text: $draft.condition)
                    .accessibilityIdentifier("field_condition")
                TextField("CardNumber", text: $draft.cardNumber)
